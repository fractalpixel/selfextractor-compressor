...
async function doCompress(source :string): Promise<string> {
    ...
    if (extractedSource != undefined) source = extractedSource
...
export default async function selectCompression(input:string, logger: Logger<ILogObj>): Promise<string> {
